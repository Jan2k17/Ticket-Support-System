<div class="card">
	<?php
		...
		$sql1 = "SELECT * FROM tickets WHERE ersteller = '$user' AND id = '$id'";
		$result1 = $conn->query($sql1);
		if ($result1->num_rows > 0) {
			while($row1 = $result1->fetch_assoc()) {
				?>
					<div class="card-header">
						<b><u><?php echo $row1['titel']; ?></u> | erstellt am: <u><?php echo $row1['erstellt']; ?></u> | erstellt von: <u><?php echo $row1['erstellern']; ?></u></b>
					</div>
					<div class="card-body">
						<?php echo $row1['text']; ?>
					</div>
		...
		<?php
			...
			if ($result3->num_rows > 0) {
				while($row3 = $result3->fetch_assoc()) {
					?>
						<div class="card-header">
							<b>Antwort von: <u><?php echo $row3['antwortvonn']; ?></u> | erstellt am: <u><?php echo $row3['erstellt']; ?></u> | erstellt von: <u><?php echo $row1['erstellern']; ?></u></b>
						</div>
						<div class="card-body">
